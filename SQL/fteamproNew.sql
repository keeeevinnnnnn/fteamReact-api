...
(70, '1', 'product', 5, 34000, '1546', '2022-07-30 13:35:57');
...
(1438, 'superShinder', '', '平民', 'superShinder', '$2a$10$re/oQiDQDOFP1bmaRnPwvO2XsiB16la6CuTb/kBi4mixOYtuUlXKi', 'superShinder@test.com', '', NULL, '', 'images.png', '2022-07-26 22:23:49', 1),
...
(1547, 'superKevin', '', '平民', 'superKevin', '$2a$10$ZZqIvOtUGFdxn05vIIUbZevGf6GkJW4AUNkyamPD.m0vUNIhAttbO', 'superKevin@test.com', '', NULL, '', 'images.png', '2022-07-31 21:51:06', 1);
...
--
ALTER TABLE `member`
  MODIFY `sid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1548;
